...
GLint main() {
	...
	Shader screenShader("../../res/shader/PostProcessing/screenShader.vs", "../../res/shader/PostProcessing/screenShader.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindBuffer(GL_UNIFORM_BUFFER, UBOMatrices);
		glBufferSubData(GL_UNIFORM_BUFFER, mat4size, mat4size, glm::value_ptr(camera.GetViewMatrix()));
		glBindBuffer(GL_UNIFORM_BUFFER, 0);
